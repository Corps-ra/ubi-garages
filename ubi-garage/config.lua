...
Config.AuthorizedVehicles = {
	car = {
		ambulance = {
			...
			{model = 'emsv', price = 5000},
			{model = 'fordambo', price = 5000},
			
		},

		doctor = {
			{model = 'emsnspeedo', price = 4500},
			{model = 'emsv', price = 5000},
			{model = 'fordambo', price = 5000},
		},

		chief_doctor = {
			{model = 'emsnspeedo', price = 3000},
			{model = 'emsv', price = 5000},
			{model = 'fordambo', price = 5000},
		},

		boss = {
			{model = 'emsnspeedo', price = 2000},
			{model = 'emsv', price = 5000},
			{model = 'fordambo', price = 5000},
		}
	},
